defmodule PhoenixChannelWorkshopWeb.Errors do
  alias Ecto.Changeset
  alias PhoenixChannelWorkshopWeb.Errors.View
  ...
  defp translate_error({message, options}) do
    if options[:count] do
      Gettext.dngettext(PhoenixChannelWorkshop.Gettext, "errors", message, message, options[:count], options)
    else
      Gettext.dgettext(PhoenixChannelWorkshop.Gettext, "errors", message, options)
    end
  end
